      ...
      "parameters": {
        ...
        "columns": {
          ...
          "value": {
            ...
            "agent": "creative",
            "timestamp": "={{new Date().toISOString()}}",
            "type": "={{$node['init-amazon-system'].json.creative_mutation_due ? 'design_generation_mutation' : 'design_generation_standard'}}",
            "data": "={{JSON.stringify($json.output)}}",
            "success": "=true"
          }
        }
  ...
  "connections": {
    ...
    "quality-gate": {
      "main": [
        [
          {
            "node": "save-quality-memory",
            "type": "main",
            "index": 0
          },
          {
            "node": "amazon-strategy-agent",
            "type": "main",
            "index": 0
          }
        ],
